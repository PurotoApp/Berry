<script lang="ts">
	...
	function toggleShowPassword(bool) {
		if (bool) {
...
<svelte:head>
	<title>Puroto - Join</title>
</svelte:head>

<div class="absolute flex w-full translate-y-16 justify-center text-center">
	<div>
		<h1 class="mb-1 text-3xl font-bold">Join Puroto</h1>
		<p class="my-1 w-80 text-gray-10">
			Enjoy a full experience by creating an account! To continue, please fill in all the fields in
			this form to create your new account.
		</p>
	</div>
</div>
<div class="flex w-full translate-y-1/2 items-center justify-center">
	<div>
			...
			<div class="w-80 rounded-lg bg-gray-4 px-3 py-3">
				<form class="bg-mint- flex justify-center">
					<div>
						...
						<button
							type="submit"
							class="mt-6 h-10 w-full rounded-lg bg-blue-4 transition hover:bg-blue-3 active:bg-blue-2"
						>
							<span class="select-none text-lg font-semibold"> Create Account </span>
						</button>
					</div>
				</form>
				<div class="mt-4 w-full text-center">
					<a class="select-none text-center text-gray-9 hover:underline" href="/login">
