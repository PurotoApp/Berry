...
{#if type == 'large'}
	<div class="grid w-full block pt-1 mb-12 rounded-lg cursor-pointer hover:bg-gray-1 transition">
		...
		<div class="bg-gray-4 rounded-lg min-h-[32px] pb-2">
			...
			<div class="absolute h-[2rem] w-1/6 flex flex-nowrap flex-row-reverse justify-between right-[15px] translate-y-[-1.25rem]">
				
				<!--	Like		-->
				<div class="w-6 h-6">
					<svg xmlns="http://www.w3.org/2000/svg" class="hover:stroke-red-2 transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
				...
				<!--	Comment		-->
				<div class="w-6 h-6">
					<svg xmlns="http://www.w3.org/2000/svg" class="hover:stroke-[#8F8EF1] transition" fill="none" viewBox="0 0 24 24" stroke="currentColor">
